...
package emma.galzio.fido2server.attestation.packed;
...
import emma.galzio.fido2server.model.OctetKey;
import emma.galzio.fido2server.util.CertificateUtil;
import emma.galzio.fido2server.util.PublicKeyUtil;
...
import emma.galzio.fido2server.model.CredentialPublicKey;
import emma.galzio.fido2server.model.ECCKey;
import emma.galzio.fido2server.model.RSAKey;
